// Regiones y comunas de Chile — 16 regiones, 346 comunas (fuente INE)
const REGIONES_COMUNAS = {
    ...
    'Coquimbo': [
        ...
        'Paiguano', 'Vicuña', 'Illapel', 'Canela', 'Los Vilos', 'Salamanca',
...
export const getComunasByRegion = (region) =>
    REGIONES_COMUNAS[region] ? [...REGIONES_COMUNAS[region]].sort() : [];
